# **11. The Playbook in Action: A Real-World Case Study**
...
The turning point of the project was the explicit adoption of **Spec-Driven Development**, as described in **Chapter 8**. The process became: no documentation would be written or modified without first creating or updating a corresponding `spec.md` file.
